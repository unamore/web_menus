...
class PlatesControllerTest < ActionController::TestCase
  ...
  test "should create plate" do
    assert_difference('Plate.count') do
      post :create, plate: { codeplate: @plate.codeplate, nameplate: @plate.nameplate, typeplate_id: @plate.typeplate_id }
    end
  ...
  test "should update plate" do
    patch :update, id: @plate, plate: { codeplate: @plate.codeplate, nameplate: @plate.nameplate, typeplate_id: @plate.typeplate_id }
    assert_redirected_to plate_path(assigns(:plate))
  end
